...
contract nft is ERC721, Ownable {
    ...
    mapping(address => bool) internal premiumMinted
    ...
    */
    ...
    function presale2Mint(uint256 number, uint8 _v, bytes32 _r, bytes32 _s) onlyValidAccess(_v,  _r, _s) public payable {
        if(premiumMinted[msg.sender] == True) {
          premiumAdjustment = -1;
        }
        else {
          premiumAdjustment = 0
        ...
        require(mintsPerAddress[msg.sender] + premiumAdjustment + number < maxMint(), "Maximum Mints per Address exceeded!");
